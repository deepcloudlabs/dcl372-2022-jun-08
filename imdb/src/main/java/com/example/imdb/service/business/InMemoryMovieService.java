...
public class InMemoryMovieService implements MovieService {
	...
	private SequenceService sequenceSrv; // reflection api
	...
	public InMemoryMovieService(SequenceService sequenceSrv) {
		System.out.println("InMemoryMovieService::InMemoryMovieService()");
		this.sequenceSrv = sequenceSrv;
	...
	@PreDestroy
	public void yoket() {
		System.out.println("Closing/Destroying the component...");
	}
	
	@PostConstruct // Life-Cycle Callback Annotation Common Annotation (JSR-250)
